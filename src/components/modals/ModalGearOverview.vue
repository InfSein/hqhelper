...
import { XivGearAffixes, XivJobs, XivJobRoleMap, HqData, type HqDataVer, type XivPatchVer } from '@/assets/data'
...
const resolvedPatchData = computed<HqDataVer | undefined>(() => {
  if (props.patchData) return props.patchData
  if (props.patchVer) {
    return HqData.patches[props.patchVer as XivPatchVer] ?? undefined
  }
  return undefined
})
...
const resolvedAttireAffix = computed<AttireAffix | ''>(() => {
  if (props.attireAffix !== undefined) return props.attireAffix
  if (props.jobId && XivJobRoleMap[props.jobId]) {
    return XivJobRoleMap[props.jobId].attire ?? ''
  }
  return ''
})

const resolvedAccessoryAffix = computed<AccessoryAffix | ''>(() => {
  if (props.accessoryAffix !== undefined) return props.accessoryAffix
  if (props.jobId && XivJobRoleMap[props.jobId]) {
    return XivJobRoleMap[props.jobId].accessory ?? ''
  }
  return ''
})
...
const getAffixesName = () => {
  ...
  if (resolvedAttireAffix.value) names.attireName = XivGearAffixes?.[resolvedAttireAffix.value]?.[`name_${uiLanguage.value}`]
  if (resolvedAccessoryAffix.value) names.accessoryName = XivGearAffixes?.[resolvedAccessoryAffix.value]?.[`name_${uiLanguage.value}`]
  return names
}
...
const weaponSlots = computed<SlotItem[]>(() => [
  {
    ...
    itemInfo: (props.jobId && resolvedPatchData.value?.mainHand?.[props.jobId])
      ? getItemInfo(resolvedPatchData.value.mainHand[props.jobId])
      : undefined
  },
  {
    slot: 'offHand',
    ...
    itemInfo: (props.jobId && resolvedPatchData.value?.offHand?.[props.jobId])
      ? getItemInfo(resolvedPatchData.value.offHand[props.jobId])
      : undefined
  }
])
...
const attireSlots = computed<SlotItem[]>(() => [
  {
    ...
    itemInfo: (resolvedAttireAffix.value && resolvedPatchData.value?.headAttire?.[resolvedAttireAffix.value])
      ? getItemInfo(resolvedPatchData.value.headAttire[resolvedAttireAffix.value])
      : undefined
  },
  {
    slot: 'bodyAttire',
    ...
    itemInfo: (resolvedAttireAffix.value && resolvedPatchData.value?.bodyAttire?.[resolvedAttireAffix.value])
      ? getItemInfo(resolvedPatchData.value.bodyAttire[resolvedAttireAffix.value])
      : undefined
  },
  {
    slot: 'handsAttire',
    ...
    itemInfo: (resolvedAttireAffix.value && resolvedPatchData.value?.handsAttire?.[resolvedAttireAffix.value])
      ? getItemInfo(resolvedPatchData.value.handsAttire[resolvedAttireAffix.value])
      : undefined
  },
  {
    slot: 'legsAttire',
    ...
    itemInfo: (resolvedAttireAffix.value && resolvedPatchData.value?.legsAttire?.[resolvedAttireAffix.value])
      ? getItemInfo(resolvedPatchData.value.legsAttire[resolvedAttireAffix.value])
      : undefined
  },
  {
    slot: 'feetAttire',
    ...
    itemInfo: (resolvedAttireAffix.value && resolvedPatchData.value?.feetAttire?.[resolvedAttireAffix.value])
      ? getItemInfo(resolvedPatchData.value.feetAttire[resolvedAttireAffix.value])
      : undefined
  }
])
...
const accessorySlots = computed<SlotItem[]>(() => [
  {
    ...
    itemInfo: (resolvedAccessoryAffix.value && resolvedPatchData.value?.earrings?.[resolvedAccessoryAffix.value])
      ? getItemInfo(resolvedPatchData.value.earrings[resolvedAccessoryAffix.value])
      : undefined
  },
  {
    slot: 'necklace',
    ...
    itemInfo: (resolvedAccessoryAffix.value && resolvedPatchData.value?.necklace?.[resolvedAccessoryAffix.value])
      ? getItemInfo(resolvedPatchData.value.necklace[resolvedAccessoryAffix.value])
      : undefined
  },
  {
    slot: 'wrist',
    ...
    itemInfo: (resolvedAccessoryAffix.value && resolvedPatchData.value?.wrist?.[resolvedAccessoryAffix.value])
      ? getItemInfo(resolvedPatchData.value.wrist[resolvedAccessoryAffix.value])
      : undefined
  },
  {
    slot: 'rings',
    ...
    itemInfo: (resolvedAccessoryAffix.value && resolvedPatchData.value?.rings?.[resolvedAccessoryAffix.value])
      ? getItemInfo(resolvedPatchData.value.rings[resolvedAccessoryAffix.value])
      : undefined
  }
])
